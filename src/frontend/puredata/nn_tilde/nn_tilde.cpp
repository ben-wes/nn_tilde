...
#ifdef _WIN32
# include <windows.h>
# include <shlwapi.h> // FIXME: only used for cudnn_graph64_9.dll - see setup method
#else
# include <dlfcn.h>
#endif
...
// FIXME: this should possibly be solved in a different way.
// used here to output model's stderr to pd console
...
// FIXME: this could also be omitted if we only support and build for Pd >=0.54
